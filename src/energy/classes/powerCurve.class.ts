...
export class PowerCurve {
    ...
    calculateStatistics(periodDistribution: any): PowerCurveStatistics {
        ...
        let anualMonthAccumulate: Record<string, Record<number | string, number>> & StatisticResult = {}

        //cuenta total de valores para cada par mes-año
        //formato -> {[YYYY]:{1: XX, 2: XX ... 12: XX} ... }
        let anualMonthCount: Record<string, Record<number | string, number>> & StatisticResult = {}
        ...
        let periodoAgregattion: Record<Year, Record<number, number>> & StatisticResult = {}

        //consumo medio por dia de la semana para cada año
        let weeklyAverageConsumption: Record<Year, Record<number | string, any>> & StatisticResult = {}

        //consumo medio por hora del dia para cada año
        let hourlyAverageConsumption: Record<Year, Record<Hour | string, any>> & StatisticResult = {}

        let weeklyhourlyAverageConsumption: Record<Year, Record<WeekDay, Record<Hour, any>>> & StatisticResult = {}
        //curva de distribución horaria por periodo para cada año para la tarifa de acceso seleccionada en la curva
        let hourlyPeriodDistribution: Record<Year, Record<string, any>> & StatisticResult = {}
        ...
        let anualMonthlyAverage: Record<number | string, Record<string, any>> & StatisticResult = {}
        ...
        let weeklyAverage: Record<number | string, Record<string, any>> & StatisticResult = {}
        ...
        let hourlyAverage: Record<number | string, Record<string, any>> & StatisticResult = {}
        //calculamos la media de los consumos diariso medios semanales
